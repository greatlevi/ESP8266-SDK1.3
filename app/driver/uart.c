 ...
 * Returns      : NONE
*******************************************************************************/
//extern void HSTest(void);
void ICACHE_FLASH_ATTR
ReceiveDataTask(void)
{
uint8_t temp;
u8 iptemp[4]={};
...
//        os_printf("%c",temp);            //可以打印接收
        switch(temp)
        {
#ifdef CloudOpen
        case 'B':
        	LetsCloud_NetReceived("/RU0Q50YV/C002/255-1-0200588080",31);
        	break;
        case 'P':
        	LetsCloud_NetReceived("/RU0Q50YV/C002/255-1-020008XXXX",31);
        	break;
#endif
