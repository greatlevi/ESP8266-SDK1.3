...
PCT_CheckCrc(u8 *pu8Crc, u8 *pu8Data, u16 u16Len)
{
    u16 u16Crc;
    u16 u16RecvCrc;
...
PCT_SendNotifyMsg(u8 u8NotifyCode)
{
    u16 u16Len;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_Init(PTC_ModuleAdapter *pstruAdapter)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_SendEmptyMsg(u8 u8MsgId, u8 u8SecType)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_SendErrorMsg(u8 u8MsgId, u8 *pu8Error, u16 u16ErrorLen)
{
    u16 u16Len;
    ZC_SecHead struSecHead;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_SendCloudAccessMsg1(PTC_ProtocolCon *pstruContoller)
{
    u16 u16Len;
    ZC_SecHead struSechead;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_ReconnectCloud(PTC_ProtocolCon *pstruContoller, u32 u32ReConnectTimer)
{
    u32 u32Index;
    if (PCT_TIMER_INVAILD != pstruContoller->u8ReconnectTimer)
    {
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_SendMoudleTimeout(PTC_ProtocolCon *pstruProtocolController)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_HandleMoudleEvent(u8 *pu8Msg, u16 u16DataLen)
{
    MSG_Buffer *pstruBuffer;
    ZC_SecHead struHead;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_RecvAccessMsg2(PTC_ProtocolCon *pstruContoller)
{
    MSG_Buffer *pstruBuffer;
    ZC_MessageHead *pstruMsg;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_RecvAccessMsg4(PTC_ProtocolCon *pstruContoller)
{
    MSG_Buffer *pstruBuffer;
    ZC_MessageHead *pstruMsg;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_HandleUnbindMsg(PTC_ProtocolCon *pstruContoller)
{
    MSG_Buffer *pstruBuffer;
    ZC_MessageHead *pstruMsg;
    pstruBuffer = (MSG_Buffer *)MSG_PopMsg(&g_struRecvQueue);
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_HandleOtaBeginMsg(PTC_ProtocolCon *pstruContoller, MSG_Buffer *pstruBuffer)
{
    ZC_MessageHead *pstruMsg;
    ZC_Printf("Ota Begin\n");
    pstruMsg = (ZC_MessageHead*)pstruBuffer->u8MsgBuffer;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_ModuleOtaFileBeginMsg(PTC_ProtocolCon *pstruContoller, u8 *pu8Msg)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_ModuleOtaFileChunkMsg(PTC_ProtocolCon *pstruContoller, ZC_MessageHead *pstruMsg, u8 *pu8Msg)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_ModuleOtaFileEndMsg(PTC_ProtocolCon *pstruContoller, u8 *pu8Msg)
{
    u32 u32RetVal;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_HandleOtaFileBeginMsg(PTC_ProtocolCon *pstruContoller, MSG_Buffer *pstruBuffer)
{
    ZC_MessageHead *pstruMsg;
    ZC_OtaFileBeginReq *pstruOta;
    ZC_Printf("Ota File Begin\n");
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_HandleOtaFileChunkMsg(PTC_ProtocolCon *pstruContoller, MSG_Buffer *pstruBuffer)
{
    ZC_MessageHead *pstruMsg;
    ZC_OtaFileChunkReq *pstruOta;
    u32 u32FileLen;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_HandleOtaFileEndMsg(PTC_ProtocolCon *pstruContoller, MSG_Buffer *pstruBuffer)
{
    ZC_MessageHead *pstruMsg;
    ZC_Printf("Ota File End\n");
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_HandleOtaEndMsg(PTC_ProtocolCon *pstruContoller, MSG_Buffer *pstruBuffer)
{
    ZC_MessageHead *pstruMsg;
    u32 u32RetVal;
    ZC_Printf("Ota End\n");
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_HandleMoudleMsg(PTC_ProtocolCon *pstruContoller, MSG_Buffer *pstruBuffer)
{
    ZC_MessageHead *pstruMsg;
    pstruMsg = (ZC_MessageHead*)pstruBuffer->u8MsgBuffer;
    ...
    memcpy((u8*)g_struRetxBuffer.u8MsgBuffer, pstruBuffer->u8MsgBuffer, pstruBuffer->u32Len);
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_SetTokenKey(PTC_ProtocolCon *pstruContoller, MSG_Buffer *pstruBuffer)
{
    ZC_MessageHead *pstruMsg;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_ResetNetWork(PTC_ProtocolCon *pstruContoller, MSG_Buffer *pstruBuffer)
{
    ZC_MessageHead *pstruMsg;
...
*************************************************/
void ICACHE_FLASH_ATTR
PCT_HandleEvent(PTC_ProtocolCon *pstruContoller)
{
    MSG_Buffer *pstruBuffer;
    ZC_MessageHead *pstruMsg;
    ...
    pstruMsg = (ZC_MessageHead*)pstruBuffer->u8MsgBuffer;
    ZC_Printf("MsgId %d MsgCode %d recv len =%d\n", pstruMsg->MsgId, pstruMsg->MsgCode, ZC_HTONS(pstruMsg->Payloadlen) + sizeof(ZC_MessageHead));
...
*************************************************/
u32 ICACHE_FLASH_ATTR
PCT_SendMsgToCloud(ZC_SecHead *pstruSecHead, u8 *pu8PlainData)
{
    u32 u32Index;
    u32 u32RetVal;
    u16 u16Len;
