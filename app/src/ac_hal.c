...
AC_UartProcess(u8* inBuf, u32 datalen) 
{ 
...
AC_SendLedStatus2Server()
{
    ...
    struRsp.u8LedOnOff = 0;//struRsp.u8LedOnOff>>2;
...
*************************************************/
void ICACHE_FLASH_ATTR
AC_DealNotifyMessage(ZC_MessageHead *pstruMsg, AC_OptList *pstruOptList, u8 *pu8Playload)
{
    ...
    g_struProtocolController.pstruMoudleFun->pfunUartSend(u8SendBuff,10);
}
...
*************************************************/
void ICACHE_FLASH_ATTR
AC_DealEvent(ZC_MessageHead *pstruMsg, AC_OptList *pstruOptList, u8 *pu8Playload)
{   
    ...
    g_struProtocolController.pstruMoudleFun->pfunUartSend(pu8SendData, Packetlen);
...
*************************************************/
void ICACHE_FLASH_ATTR
AC_StoreStatus(u32 u32Type , u32 u32Data)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
AC_BlinkLed(unsigned char blink)
{
    if(blink)
    {
...
*************************************************/
void ICACHE_FLASH_ATTR
AC_DealLed(ZC_MessageHead *pstruMsg, AC_OptList *pstruOptList, u8 *pu8Playload)
{
    u16 u16DataLen;
    u8 test[] = {1,0,0,0};
