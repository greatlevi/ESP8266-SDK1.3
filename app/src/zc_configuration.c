...
ZC_ResetAccessInfo()
{
    ...
    spi_flash_read(0, (unsigned int*)&g_struZcConfigDb, sizeof(ZC_ConfigDB));
...
*************************************************/
void ICACHE_FLASH_ATTR
ZC_StoreRegisterInfo(u8 *pu8Data,u8 u8RegisterFlag)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
ZC_StoreConnectionInfo(u8 *pu8Ssid, u8 *pu8Password)
{
    g_struZcConfigDb.struConnection.u32MagicFlag = ZC_MAGIC_FLAG;
...
*************************************************/
void ICACHE_FLASH_ATTR
ZC_StoreAccessInfo(u8 *pu8ServerIp, u8 *pu8ServerPort)
{
    g_struZcConfigDb.struConnection.u32MagicFlag = ZC_MAGIC_FLAG;
...
*************************************************/
void ICACHE_FLASH_ATTR
ZC_GetStoreInfor(u8 u8Type, u8 **pu8Data)
{
    switch(u8Type)
    {
...
*************************************************/
void ICACHE_FLASH_ATTR
ZC_ConfigUnBind(u32 u32UnBindFlag)
{
