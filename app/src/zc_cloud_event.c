...
EVENT_BuildEmptyMsg(u8 u8MsgId, u8 *pu8Msg, u16 *pu16Len)
{
...
*************************************************/
u32  ICACHE_FLASH_ATTR
EVENT_BuildHeartMsg(u8 *pu8Msg, u16 *pu16Len)
{
    ZC_MessageHead *pstruMsg = NULL;
    u16 crc = 0;
    pstruMsg = (ZC_MessageHead *)pu8Msg;
...
*************************************************/
u32  //ICACHE_FLASH_ATTR
EVENT_BuildMsg(u8 u8MsgCode, u8 u8MsgId, u8 *pu8Msg, u16 *pu16Len, u8 *pu8Payload, u16 u16PayloadLen)
{
    ZC_MessageHead *pstruMsg = NULL;
    u16 crc = 0;
    pstruMsg = (ZC_MessageHead *)pu8Msg;
...
*************************************************/
u32  ICACHE_FLASH_ATTR
EVENT_BuildBcMsg(u8 *pu8Msg, u16 *pu16Len)
{
...
EVENT_ParseOption(ZC_MessageHead *pstruMsg, ZC_OptList *pstruOptList, u16 *pu16OptLen)
{
    u8 u8OptNum;
...
*************************************************/
void ICACHE_FLASH_ATTR
EVENT_BuildOption(ZC_OptList *pstruOptList, u8 *pu8OptNum, u8 *pu8Buffer, u16 *pu16Len)
{
