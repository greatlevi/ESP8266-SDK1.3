...
crc_cal_by_bit(const unsigned char* ptr, unsigned int len)
{
    unsigned int crc = 0;
    unsigned char i;
    while(len-- != 0)
...
*/
unsigned int ICACHE_FLASH_ATTR
crc_cal_by_byte(const unsigned char* ptr, unsigned int len)
{
...
*/
unsigned int ICACHE_FLASH_ATTR
crc_cal_by_halfbyte(const unsigned char* ptr, unsigned int len)
{
    unsigned short crc = 0;
...
crc16_ccitt(const unsigned char *buf, unsigned int len)
{
