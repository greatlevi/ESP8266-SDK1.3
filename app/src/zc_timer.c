...
TIMER_FindIdleTimer(u8 *pu8TimerIndex)
{
    u8 u8Index;
...
*************************************************/
void ICACHE_FLASH_ATTR
TIMER_AllocateTimer(u8 u8Type, u8 u8TimerIndex, u8 *pu8Timer)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
TIMER_GetTimerStatus(u8 u8TimerIndex, u8 *pu8Status)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
TIMER_TimeoutAction(u8 u8TimerIndex)
{
