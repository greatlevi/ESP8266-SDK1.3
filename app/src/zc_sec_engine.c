...
SEC_EncryptTextByRsa(u8* pu8CiperBuf, u8 *pu8Plainbuf, u16 u16Len, u16 *pu16CiperLen)
{
    s32 s32Ret;
    u8 *pu8PublicKey;
    u16 u16ReadLen;
...
*************************************************/
u32 ICACHE_FLASH_ATTR
SEC_DecryptTextByRsa(u8* pu8CiperBuf, u8 *pu8Plainbuf, u16 u16Len, u16 *pu16PlainLen)
{
...
SEC_InitRsaContextWithPublicKey(rsa_context *pstruRsa, const u8 *pu8Pubkey)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
SEC_InitRsaContextWithPrivateKey(rsa_context *pstrRsa, const u8 *pu8PrivateKey)
{
    u8 u8Index;
    u16 u16StartPos;
...
*************************************************/
u32 ICACHE_FLASH_ATTR
SEC_AesEncrypt(u8* pu8CiperBuf, u8 *pu8Plainbuf, u16 u16Len, u16 *pu16CiperLen)
{
    u32 u32OutLen;
...
*************************************************/
u32 ICACHE_FLASH_ATTR
SEC_AesDecrypt(u8* pu8CiperBuf, u8 *pu8Plainbuf, u16 u16Len, u16 *pu16PlainLen)
{
    u8 *pu8Key;
    u8 *pu8IvRecv;
    //u8 u8NextIv[16];
...
*************************************************/
u32 ICACHE_FLASH_ATTR
SEC_PaddingCheck(u8 u8SecType, u16 u16PlainLen, u16 *u16PaddingLen)
{
    u16 LastBlockSize = 0;
    u8 u8SecFlag;
    *u16PaddingLen = 0;
...
*************************************************/
u32 ICACHE_FLASH_ATTR
SEC_Encrypt(ZC_SecHead *pstruSecHead, u8 *pu8CiperBuf, u8 *pu8PlainBuf, u16 *pu16CiperLen)
{
...
*************************************************/
u32 ICACHE_FLASH_ATTR
SEC_Decrypt(ZC_SecHead *pstruSecHead, u8 *pu8CiperBuf, u8 *pu8PlainBuf, u16 *pu16PlainLen)
{
    u32 u32RetVal = ZC_RET_ERROR;
