...
ZC_ClientDisconnect(u32 u32ClientId)
{
    u32 u32Index;
...
ZC_ClientConnect(u32 u32ClientId)
{
    u32 u32Index;
...
*************************************************/
void ICACHE_FLASH_ATTR
ZC_SetClientBusy(u32 u32Clientfd)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
ZC_SetClientFree(u32 u32Clientfd)
{
...
*************************************************/
void ICACHE_FLASH_ATTR
ZC_RecvDataFromClient(u32 ClientId, u8 *pu8Data, u32 u32DataLen)
{
    u32 u32RetVal;
