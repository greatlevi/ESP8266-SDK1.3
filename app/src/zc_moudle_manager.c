...
ZC_DealSessionOpt(ZC_MessageHead *pstruMsg, ZC_OptList *pstruOptList, u8 *pu8PayLoad)
{
    u32 u32Index;
    u32 u32ClientId;
    u16 u16RealLen;
...
*************************************************/
u32 ICACHE_FLASH_ATTR
ZC_RecvDataFromMoudle(u8 *pu8Data, u16 u16DataLen)
{
...
*************************************************/
u32 ICACHE_FLASH_ATTR
ZC_AssemblePkt(u8 *pu8Data, u32 u32DataLen, u32 *pu32LeftLen)
{
    ZC_MessageHead *pstruMsg;
...
ZC_Moudlefunc(u8 *pu8Data, u32 u32DataLen)
{
    u32 u32RetVal;
    u32 u32MagicLen = ZC_MAGIC_LEN;
    u32 u32LeftLen = 0;
